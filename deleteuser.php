...
echo" <h2 id = 'Welcome'>Welcome to Delete User page</h2>";
echo"<p>Fill the form below and submit to add a new username and password and submit.</p>
  ...
  <table >
    ...
    <tr>
     <td><label class='control-label'>Password</label></td>
        <td><input id='caption' type='text' name = 'password' placeholder='Enter password'/></td>
    </tr>
    <tr>
  ...
  $password = $_POST['password'];
    if (empty($password)) {
      ...
      $sql = "DELETE FROM pass WHERE email='$email'";
      //echo
